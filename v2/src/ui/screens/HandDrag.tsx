...
export default function HandDrag() {
  ...
  const nextHand = async () => {
    ...
    try {
      ...
      nav(`/sessions/${session.id}/hands/${nh.id}/drag`);
    } finally {
      busyRef.current = false;
      setBusy(false);
    }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative">
        ...
        {/* Drag input overlay — anchored to the current actor's seat. Reads
            ...
            top of the avatar. Hidden when the action panel takes over or the
            hand is finalized (view-only). */}
        {!showResult && !readOnly && state.currentSeat !== null && (
          <DragInput

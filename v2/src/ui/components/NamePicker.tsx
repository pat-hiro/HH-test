...
export default function NamePicker({
  ...
  const pastNames = suggestions.filter((s) => s && s !== "Unknown").slice(0, 20);
  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="bg-neutral-900 w-full max-w-xl mx-auto p-4 rounded-t-xl border-t border-neutral-800 safe-bottom max-h-[85vh] overflow-y-auto"
